...
pour chaque sous ensemble un échantillon aléatoire de features}, ce qui
...
Nous récupérons les hyperparamètres ayant produit le meilleur résultat et
calculons le score final par cross-validation sur les données de test. \\

Les métriques utilisées sont le taux de bonne
classification (\emph{accuracy}) et l'AMS. Les modèles sont optimisés selon
chaque mesure. 
...
\begin{table}[H]
    \resizebox{\textwidth}{!}{
        \begin{tabular}{c|*{7}{c|}c}
            ...
            Profondeur max & \cellcolor{gray!40} & \cellcolor{gray!40} & 50 & 50 &
            $\inf$ & $\inf$ & \cellcolor{gray!40} & \cellcolor{gray!40} \\
        \end{tabular}}
...
\begin{table}[H]
    \resizebox{\textwidth}{!}{
        \begin{tabular}{c|*{3}{c|}c}
            ...
            \hline
            SVM & $75.20 \pm 1.55$ \% & $75.30 \pm 0.42$ \%& $0.0414 \pm
            0.0049$ &  $0.0301 \pm 0.0023$\\
            Bagging & $73.30 \pm 1.24$ \% & $71.80 \pm 0.71$ \% & $0.0290 \pm
            0.0029$ & $0.0233 \pm 0.0026$\\ 
            RF & $80.20 \pm 0.50$ \% & $80.70 \pm 0.62 $\% & $0.0510 \pm
            0.0093$ & $0.0379 \pm 0.0028$\\
            RFNan & $81.70 \pm 0.17$ \% & $81.40 \pm 0.82$ \%& $0.0514 \pm
            0.0100$ & $0.0400 \pm 0.0037$\\
            AdaBoost & $74.30 \pm0.79$ \% & $74.50 \pm 0.58$ \%& $0.0403 \pm
            0.0035$ & $0.0341 \pm 0.0007$\\
        \end{tabular}}
    \caption{Performances obtenues avec chaque méthode $|X_{test}|=1000$)}
