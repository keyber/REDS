...
%Certaines variables sont fortement corrélées (par exemple la masse et la masse
%transverse avec une corrélation de -0,45). Ces informations pourrnt se révéler
%utiles si l'on souhaite traiter les évènements à données manquantes.
